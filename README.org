...
#+CALL: sample(font_file="sachacHandRaw.otf", filename="check/unkerned.png")
...
#+CALL: sample(font_file="sachacHandKerned.otf", filename="check/kerned.png")

#+RESULTS:
[[file:files/check/kerned.png]]

After tweaking the glyphs to make them more even.
#+CALL: sample(font_file="sachacHand.otf", filename="check/edited-glyphs.png") 
