...
#+CALL: sample(font_file="sachacHandRaw.otf", filename="check/unkerned.png") :exports code

[[./files/check/unkerned.png]]

After tweaking the glyphs to make them more even:

#+CALL: sample(font_file="sachacHandEdited.otf", filename="check/edited-glyphs.png")  :exports code

[[./files/check/edited-glyphs.png]]

After kerning:

#+CALL: sample(font_file="sachacHand.otf", filename="check/kerned.png") :exports code

[[./files/check/kerned.png]]
