...
*** Code to make the template
 ...
 def draw_letter(origin, letter, params):
   ...
   draw.line((origin[0], origin[1], origin[0] + params['em_width'], origin[1]), fill='blue', width=params['line_width'])
...
*** Actually make the templates
 ...
 #+begin_src python :results file :eval yes
   ...
   make_template({**params, 'font_name': 'sachacHand.otf', 'template': 'template-sachacHand.png'})
