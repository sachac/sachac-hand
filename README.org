...
#+NAME: kerning_matrix
  ...
  | T     |    0 |            -190 |        -120 |       -60 | 0 |      -130 |    0 |    0 | -188 |
  | F     |    0 |            -100 |         -90 |       -60 | 0 |       -70 | -100 |  -40 | -166 |
  | P     |    0 |            -100 |         -90 |       -60 | 0 |       -70 | -100 |      |      |
  | two   |    0 |               0 |           0 |         0 | 0 |         0 |    0 |    0 |  -53 |

#+NAME: kern_classes
#+begin_src python :results output :var kerning_matrix=kerning_matrix :session "kern"
  <<params>>
  <<def_kern_classes>>
